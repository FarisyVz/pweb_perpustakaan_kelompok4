...
if ($is_filtered) {
    ...
    $query = "SELECT p.*, m.nama_mahasiswa, m.nim, b.judul, k.tgl_kembali_aktual, k.total_denda 
              ...
              WHERE k.total_denda > 0 
              AND MONTH(k.tgl_kembali_aktual) = '$bulan_safe' 
...
<head>
    <meta charset="UTF-8">
    <title>Laporan Denda | Metamedia Library</title>
    <style>
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="content-body">
            <h1 class="page-title">Arsip Laporan Denda</h1>
            <div class="panel-container">
                ...
                <div class="panel-body">
                    <form method="GET" style="display:flex; gap:10px; align-items:flex-end;">
                        ...
                        <button type="submit" style="padding:8px 15px; background:#1e3a8a; color:white; border:none; cursor:pointer; border-radius:4px;">Filter</button>
                        <a href="lap_denda.php" style="padding:8px 15px; background:#64748b; color:white; text-decoration:none; border-radius:4px;">Reset</a>
                        <a href="laporan/proses_excel_denda.php?bulan=<?php echo $bulan; ?>&tahun=<?php echo $tahun; ?>" class="btn-excel">📥 Download Excel</a>
                    </form>
                </div>
            </div>

            <div class="panel-container">
                <div class="panel-header">📋 Riwayat Denda</div>
                <div class="panel-body">
                    <table class="data-table">
                        <thead><tr><th>No</th><th>NIM</th><th>Nama</th><th>Judul Buku</th><th>Tgl Kembali</th><th>Total Denda (Rp)</th></tr></thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo number_format($p['total_denda'], 0, ',', '.'); ?></td>
                            </tr>
                            <?php } } else { echo "<tr><td colspan='6'>Tidak ada data denda.</td></tr>"; } ?>
                        </tbody>
                    </table>
                </div>
            </div>
