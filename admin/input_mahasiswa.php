...
<head>
    ...
    <title>Tambah Mahasiswa - Admin Metamedia</title>
    <style>
    ...
    <div class="main-container">
        ...
        <div class="content-body">
            ...
            <div class="panel-container">
                <div class="panel-header">Formulir Tambah Data Baru</div>
                <form action="proses_input.php" method="POST">
                    <label>NIM</label>
                    <input type="text" name="nim" class="form-control" required autocomplete="off">
