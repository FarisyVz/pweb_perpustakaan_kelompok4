...
if (isset($_GET['search'])) {
    ...
    $query_buku = "SELECT * FROM buku WHERE (judul LIKE '%$search%' OR penulis LIKE '%$search%') AND stok_tersedia > 0 ORDER BY judul ASC";
} else {
    $query_buku = "SELECT * FROM buku WHERE stok_tersedia > 0 ORDER BY judul ASC";
}
...
<head>
    ...
    <title>Buku Tersedia (A-Z) | Metamedia Library</title>
    <style>
        * { box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .meta-item.stock-count { color: #16a34a; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="breadcrumb-box">
            ...
            <span class="current">Rak Buku Tersedia 📚</span>
            <span class="separator">›</span>
        ...
        <div class="search-container">
            <form action="" method="GET" class="search-form">
                <input type="text" name="search" class="search-input" placeholder="Cari berdasarkan judul buku yang ready di rak..." value="<?php echo htmlspecialchars($search); ?>">
                <button type="submit" class="btn-search">🔍</button>
            </form>
        </div>

        <div class="section-header">
            <div><span>📋</span> Koleksi Buku Ready (<?php echo $total_buku; ?>)</div>
            <div class="az-indicator">Urutan: Huruf A - Z</div>
        </div>
        ...
        <div class="books-grid">
            ...
            <div class="book-card">
                ...
                <div class="book-details">
                    ...
                    <div class="book-subtitle">Katalog Utama / Karya <?php echo $buku['penulis']; ?></div>
                ...
                <div class="book-meta-footer">
                    <div class="meta-item love-count">
                        <span>❤️</span> <?php echo ($buku['id_buku'] * 3) % 10; ?>
                    </div>
                    <div class="meta-item stock-count">
                        <span>✅</span> Ready: <?php echo $buku['stok_tersedia']; ?> Eks
                    </div>
                </div>
            </div>
            <?php 
                ...
                echo "<div style='grid-column: 1/-1; text-align:center; padding: 40px; color:#64748b;'>Saat ini tidak ada buku yang tersedia di rak peminjaman.</div>";
            }
            ?>
        </div>
